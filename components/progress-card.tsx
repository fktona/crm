          ...
          <div className="flex items-start justify-between gap-4">
            <div className="flex items-center gap-3 justify-between flex-1">
              ...
              <div className="space-y-4  max-w-[50%]">
                <div className="text-right shrink-0 flex justify-end items-center gap-2">
                ...
                <div className="flex flex-wrap gap-4 md:gap-6">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm">Won $15m</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <div className="h-3 w-3 rounded-full bg-blue-500" />
                    <span className="text-sm">Committed $5m</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <div className="h-3 w-3 rounded-full bg-purple-500" />
                    <span className="text-sm">Best case $7m</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <div className="h-3 w-3 rounded-full bg-pink-500" />
                    <span className="text-sm">Qualified $5m</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <div className="h-3 w-3 rounded-full bg-slate-200" />
                    <span className="text-sm">Leads $15m</span>
                  </div>
                </div>
              </div>
            </div>
              ...
              <Card key={lead.name} className="p-4">
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1 ">
                    ...
                    <div className="bg-blue-500/10 p-3 rounded-lg relative">
